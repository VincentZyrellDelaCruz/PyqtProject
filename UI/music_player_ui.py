...
"}")
        ...
        self.lyrics_page = QtWidgets.QWidget()
        self.lyrics_page.setObjectName("lyrics_page")
        self.frame_2 = QtWidgets.QFrame(parent=self.lyrics_page)
        self.frame_2.setGeometry(QtCore.QRect(0, 0, 601, 231))
        self.frame_2.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.frame_2.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame_2.setObjectName("frame_2")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(parent=self.frame_2)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(40, 20, 521, 191))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.lyrics_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.lyrics_layout.setContentsMargins(0, 0, 0, 0)
        self.lyrics_layout.setObjectName("lyrics_layout")
        self.stackedWidget.addWidget(self.lyrics_page)
...
"}")
        ...
        self.lyrics_tab = QtWidgets.QPushButton(parent=self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lyrics_tab.sizePolicy().hasHeightForWidth())
        self.lyrics_tab.setSizePolicy(sizePolicy)
        self.lyrics_tab.setStyleSheet("QPushButton {\n"
"    color: rgb(255, 255, 255);\n"
"    border: 2px solid white;\n"
"}\n"
"QPushButton:checked {\n"
...
"    background-color: #1DB954;\n"
"}")
        self.lyrics_tab.setCheckable(True)
        self.lyrics_tab.setAutoExclusive(True)
        self.lyrics_tab.setObjectName("lyrics_tab")
        self.tabs.addWidget(self.lyrics_tab)
...
"}")
        ...
        self.volume_frame.setGeometry(QtCore.QRect(540, 330, 44, 151))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lyrics_tab.setText(_translate("Dialog", "Karaoke"))
